...
class InputTransition(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.relu1(layers.Add()(out, x_tile))
...
class UpTransition(nn.Module):
    ...
    def forward(self, x, skipx):
        ...
        out = self.ops(xcat)
        out = self.relu2(layers.Add()(out, xcat))
...
class VNet(nn.Module):
    ...
    def test(self):
        ...
        input_tensor = torch.as_tensor(a, dtype=torch.float32)
        ...
        summary(self.to(torch.device('cuda')), (self.in_channels, 32, 32, 32))
