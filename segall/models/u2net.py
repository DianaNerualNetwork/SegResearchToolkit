...
### RSU-7 ###
class RSU7(nn.Module):  #UNet07DRES(nn.Layer):
...
### RSU-6 ###
class RSU6(nn.Module):  #UNet06DRES(nn.Layer):
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
...
### RSU-5 ###
class RSU5(nn.Module):  #UNet05DRES(nn.Layer):
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
...
### RSU-4 ###
class RSU4(nn.Module):  #UNet04DRES(nn.Layer):
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
...
### RSU-4F ###
class RSU4F(nn.Module):  #UNet04FRES(nn.Layer):
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
