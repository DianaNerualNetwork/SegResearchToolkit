...
<!-- - [SEGALL_EXT and SEGALL_JIT environment variables](#basicsr_ext-and-basicsr_jit-environment-variables) -->
...
<!-- ## SEGALL_EXT_EXT and SEGALL_JIT Environment Variables

If you want to use PyTorch C++ extensions:<br>
&emsp;deformable convolution: [*dcn*](segall/models/ops) (For torchvision>=0.9.0, we use the official `torchvision.ops.deform_conv2d` instead)<br>
&emsp;cupy: TODO <br> -->
<!-- you also need to:
